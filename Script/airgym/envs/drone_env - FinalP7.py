...
class AirSimDroneEnv(AirSimEnv):
    def __init__(self, ip_address, step_length, image_shape):
        ...
        #self.action_space = spaces.Discrete(4) # Number of possible actions/movements in the action_space
    ...
    def _get_obs(self): # Observation space
        ...
        try:
            self.depthDistance = (70/328)*int(np.nanmin(img_depth))
        except:
    ...
    def _compute_reward(self):
        ...
        if self.state["collision"]:
            ...
            reward += reward_obj_center

            if episode_length >= 30 or self.depthDistance < 30.0:
